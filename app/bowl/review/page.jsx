  ...
  return (
    <div className="min-h-screen w-screen bg-red flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-center mt-[10vh] sm:mt-[30vh]">
        <h2 className="text-large sm:text-xl text-white p-4">
          Thanks for visiting:
        </h2>
        <h1 className="title text-2xl sm:text-3xl text-center text-white font-title">
          Jenny and Jacob's
          <br />
        ...
        <div className="max-w-full overflow-x-hidden w-64 sm:w-[500px] py-12 flex flex-col justify-center items-center">
          <div
            id="review-form"
            className="w-full bg-white min-h-[17rem] my-4 mx-4 border-8 border-black p-4 flex justify-center items-center"
          >
            {reviewed ? (
                ...
                <form onSubmit={handleSubmit}>
                  <fieldset className="rating text-xl inline-block relative">
                    <label htmlFor="1-star">
                      <input id="1-star" name="rating" value="1" type="radio" />
                      <span className="icon">★</span>
                    </label>
                    <label htmlFor="2-star">
                      <input id="2-star" name="rating" value="2" type="radio" />
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                    </label>
                    <label htmlFor="3-star">
                      <input id="3-star" name="rating" value="3" type="radio" />
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                    </label>
                    <label htmlFor="4-star">
                      <input id="4-star" name="rating" value="4" type="radio" />
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                    ...
                    <label htmlFor="5-star">
                      <input id="5-star" name="rating" value="5" type="radio" />
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                      <span className="icon">★</span>
                    ...
                    >
                      <textarea
                        ...
                        placeholder={
                          placeholderReviews[
                            Math.floor(
                              Math.random() * placeholderReviews.length
                            )
                          ]
                        }
          ...
          <div
            id="review-page"
            className="w-full bg-white mx-4 border-8 p-4 border-black"
          >
            {reviews ? (
